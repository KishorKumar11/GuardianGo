...
abstract class AppLocalizations {
  ...
  /// No description provided for @documentsMode.
  ///
  /// In en, this message translates to:
  /// **'Documents'**
  String get documentsMode;

  /// No description provided for @salaryMode.
  ///
  /// In en, this message translates to:
  /// **'Salary'**
  String get salaryMode;

  /// No description provided for @evidenceMode.
  ///
  /// In en, this message translates to:
  /// **'Evidence'**
  String get evidenceMode;

  /// No description provided for @rightsMode.
  ///
  /// In en, this message translates to:
  /// **'Rights'**
  String get rightsMode;
  ...
  ///
  /// In en, this message translates to:
  /// **'Couldn\'t read clearly — try better lighting'**
  ...
  /// No description provided for @momHotline.
  ///
  /// In en, this message translates to:
  /// **'Not sure? Call MOM: 6438 5122'**
  String get momHotline;
  ...
  /// No description provided for @importQr.
  ///
  /// In en, this message translates to:
...
class _AppLocalizationsDelegate
  ...
  bool isSupported(Locale locale) =>
      <String>['bn', 'en', 'ta', 'zh'].contains(locale.languageCode);
